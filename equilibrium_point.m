...
rho_freshwater = 997 * (1 - 0.00021 * (temperature_range - 20)); % Density of fresh water (kg/m^3)

% Density range for saltwater at different temperatures
rho_saltwater = 1025 * (1 - 0.00023 * (temperature_range - 20)); % Density of saltwater (kg/m^3)
